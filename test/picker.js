...
describe("<Picker></Picker>", () => {
  ...
  it("should render PickerGroup", () => {
    ...
    const wrapper = mount(<Picker show groups={groups} />);
  ...
  it("should render 2 action button by default", () => {
    const wrapper = mount(<Picker show />);
  ...
  it("should trigger onCancel when click cancel", () => {
    let cb = sinon.spy();
    const wrapper = mount(<Picker show onCancel={cb} />);
  ...
  it("should trigger onGroupChange after scroll", () => {
    let value = null,
      changeCb = (item, i, groupIndex) => (value = groupIndex);
  ...
  it("should trigger onChange after scroll and click selected", () => {
    let value = "",
      changeCb = selected => (value = selected);
    ...
    const wrapper = mount(<Picker show groups={groups} onChange={changeCb} />);
